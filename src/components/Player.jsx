    ...
    >
      ...
      <div className="flex flex-col">
        <a href={`/playlist/${albumId}`}>
          <h3 className="font-semibold text-sm block hover:opacity-90 hover:underline hover:decoration-1">
            {title}
          </h3>
        </a>
        <a
          href={`/playlist/${albumId}`}
          className="text-xs opacity-80  hover:opacity-90 hover:underline hover:decoration-1"
        >
          {artists?.join(", ")}
        </a>
      </div>
